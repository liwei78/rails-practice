...
本书通过一个在线网店（shop）的实际开发过程，带领大家了解 Rails 全貌，并引领大家完成项目交付。其中，还增加了我对敏捷开发的理解。我不主张所谓的由浅入深，在实际项目开发中，我提倡做“正确的选择”。每一个环节，我会从实践开发入手，讲解知识点，并且编写 Rspec 测试。最后，还会带领大家实际部署运行这个项目。
